...
<head>
  ...
  <title>Dadavaai | Vendor Log in</title>
...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <form action="{{url('vendor-login')}}" method="post">
      ...
      <div class="form-group has-feedback">
        <input type="password" class="form-control" name="vendor_password" placeholder="Password">
...
{{--     <div class="social-auth-links text-center">
    ...
    <a href="{{url('/vendor-forgot-password')}}">I forgot my password</a><br>
    <a href="{{url('/vendor-registration')}}" class="text-center">Register a new membership</a>
