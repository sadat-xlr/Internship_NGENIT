...
<head>
  ...
  <title>Dadavaai | Vendor Registration Page</title>
...
<div class="register-box">
  <div class="register-logo">
    <a href="#"><b>DADA</b>VAAI <small>vendor</small> </a>
    <small>
      @include('inc.message')
    </small>
  ...
  <div class="register-box-body">
    ...
    <form action="{{url('vendor-registration')}}" method="post">
      {{ csrf_field() }}
      ...
      <div class="form-group has-feedback">
        <input type="email" class="form-control" name="vendor_email" placeholder="Email" required>
        <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
        <input type="number" class="form-control" name="vendor_phone" placeholder="Phone number" required>
        <span class="glyphicon glyphicon-phone form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
        <input type="password" class="form-control" name="vendor_password" placeholder="Password" required>
