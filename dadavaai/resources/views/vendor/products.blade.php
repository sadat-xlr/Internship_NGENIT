        ...
        <div class="box-body">
            <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                    ...
                    <th>
                        action
                        <a href="#" class="addVendorProduct btn btn-success btn-sm">
                ...
                @foreach($vendorProducts as $vendorProduct)
                    <tr id="vendorProduct{{$vendorProduct->id}}">
                        <td>{{$vendorProduct->productName}}</td>
                        <td><img src="{{asset('storage/images/product/'.$vendorProduct->image->image1)}}" height="100px" width="100px"/></td>
                        <td>{{$vendorProduct->sku}}</td>
                        <td>{{$vendorProduct->category->categoryName}}</td>
                        <td>{{$vendorProduct->subcategory->subCategoryName}}</td>
                        <td>{{$vendorProduct->minicategory->miniCategoryName}}</td>
                        <td> Tk {{$vendorProduct->regularPrice}}</td>
                        <td>
                            @if($vendorProduct->published == false)
                                Published
                            @else
                                Unpublished
                            @endif
                        ...
                        <td>
                            <div class="table-data-feature">
                                <a href="#" class="show-product btn btn-info btn-sm" data-id="{{$vendorProduct->id}}" data-delivery_charge="{{$vendorProduct->delivery_charge}}" data-return_policy="{{strip_tags($vendorProduct->return_policy)}}" data-measurement="{{$vendorProduct->measurement}}" data-min_order_qty="{{$vendorProduct->min_order_qty}}" data-delivery_time="{{$vendorProduct->delivery_time}}" data-delivery_from="{{$vendorProduct->delivery_from}}" data-productName="{{$vendorProduct->productName}}" data-slug="{{$vendorProduct->slug}}" data-image="{{$vendorProduct->image->image1}}" data-sku="{{$vendorProduct->sku}}" data-category="{{$vendorProduct->category->categoryName}}" data-subcategory="{{$vendorProduct->subcategory->subCategoryName}}" data-minicategory="{{$vendorProduct->minicategory->miniCategoryName}}" data-tab="{{$vendorProduct->tab->tabName}}"  data-brand="{{$vendorProduct->brand->brandName}}" data-color="@foreach($vendorProduct->colors as $color) {{$color->color}} @endforeach" data-size="@foreach($vendorProduct->sizes as $size) {{$size->size}} @endforeach" data-tag="@foreach($vendorProduct->tags as $tag) {{$tag->tagName}} @endforeach" data-regularPrice="{{$vendorProduct->regularPrice}}" @if ($vendorProduct->deal_id)
                                    data-deal="{{$vendorProduct->deal->discount_value}}% till {{$vendorProduct->deal->valid_until}}"
                                @endif  data-availability="@if($vendorProduct->availability == 0) Yes @else No @endif" data-type="@if($vendorProduct->type == 0) Featured @else Non-Featured @endif" data-payment="@if($vendorProduct->paymentOption == 0) Cash on Delivery @else Advance Payment @endif" data-description="{{$vendorProduct->description}}" data-specification="{{$vendorProduct->specification}}" data-short_description="{{$vendorProduct->shortDescription}}" 
                                data-discount="{{$vendorProduct->discount}}" data-occasion="{{$vendorProduct->occasion}}" data-promotion="{{$vendorProduct->promotion}}" data-clearance="{{$vendorProduct->clearance}}" data-buy_get="{{$vendorProduct->buy_get}}" >
                                    <i class="fa fa-eye"></i>
                                </a>
                                
                                <a href="#" class="edit-vendor-product btn btn-warning btn-sm" data-id="{{$vendorProduct->id}}" data-delivery_charge="{{$vendorProduct->delivery_charge}}" data-return_policy="{{strip_tags($vendorProduct->return_policy)}}" data-measurement="{{$vendorProduct->measurement}}" data-min_order_qty="{{$vendorProduct->min_order_qty}}" data-delivery_time="{{$vendorProduct->delivery_time}}" data-delivery_from="{{$vendorProduct->delivery_from}}" data-productName="{{$vendorProduct->productName}}" data-slug="{{$vendorProduct->slug}}" data-sku="{{$vendorProduct->sku}}" data-category_id="{{$vendorProduct->category_id}}" data-subcategory_id="{{$vendorProduct->subcategory_id}}" data-minicategory_id="{{$vendorProduct->minicategory_id}}" data-minicategory="{{$vendorProduct->minicategory->miniCategoryName}}" data-tab_id="{{$vendorProduct->tab_id}}" data-tab="{{$vendorProduct->tab->tabName}}"  data-brand_id="{{$vendorProduct->brand_id}}" data-color="@foreach($vendorProduct->colors as $color) {{$color->color}} @endforeach" data-size="@foreach($vendorProduct->sizes as $size) {{$size->size}} @endforeach" data-tag="@foreach($vendorProduct->tags as $tag) {{$tag->tagName}} @endforeach" data-regularPrice="{{$vendorProduct->regularPrice}}" data-availability="{{$vendorProduct->availability}}" data-type="{{$vendorProduct->type}}" data-payment="{{$vendorProduct->paymentOption}}"
                                @if ($vendorProduct->deal_id)
                                    data-deal_id="{{$vendorProduct->deal_id}}"
                                @endif  
                                data-description="{{$vendorProduct->description}}" data-specification="{{$vendorProduct->specification}}" data-subcategory="{{$vendorProduct->subcategory->subCategoryName}}" data-short_description="{{$vendorProduct->shortDescription}}" data-discount="{{$vendorProduct->discount}}" data-occasion="{{$vendorProduct->occasion}}" data-promotion="{{$vendorProduct->promotion}}" data-clearance="{{$vendorProduct->clearance}}" data-buy_get="{{$vendorProduct->buy_get}}">
                                    <i class="fa fa-edit"></i>
                                </a>
                                <a href="#" class="delete-product btn btn-danger btn-sm" data-id="{{$vendorProduct->id}}">
