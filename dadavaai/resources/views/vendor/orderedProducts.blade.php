        ...
        <table id="example1" class="table table-bordered table-striped">
            ...
            @foreach($orderForVendors as $orderForVendor)
                ...
                <tr id="orderForVendor{{$orderForVendor->id}}">
                    ...
                    <td> <a href="{{url('vendor-order-details?order_id='.$orderForVendor->order_id)}}">Details</a></td>
                    @if($deliveryStatus)
                        <td>
                     ...
                     @endif
                    <td>
                        <a href="#" class="delivery-status btn btn-success btn-sm" data-order_id="{{$orderForVendor->order_id}}" data-vendor_id="{{$orderForVendor->vendor_id}}">
                            Delivery status
                        </a>
            ...
            @foreach($orderForVendors as $orderListForVendor)
                ...
                @if($deliveryStatus->status == 2)
                    <tr id="orderListForVendor{{$orderListForVendor->id}}">
                        ...
                        <td> <a href="{{url('vendor-order-details?order_id='.$orderListForVendor->order_id)}}">Details</a></td>
                        @if($deliveryStatus)
                            <td>
