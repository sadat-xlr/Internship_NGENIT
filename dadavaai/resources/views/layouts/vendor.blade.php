...
<head>
  ...
  <!-- Select2 -->
  <link rel="stylesheet" href="{{asset('vendor/bower_components/select2/dist/css/select2.min.css')}}">
  <!-- Theme style -->
  ...
  <![endif]-->
  <link rel="shortcut icon" href="{{asset('vendor/dadavaai-favicon.png')}}" type="image/x-icon">
...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <span class="logo-lg"><b>Dada</b>Vaai <small>(vendor)</small> </span>
            </a>
            ...
            <div class="navbar-custom-menu">
                ...
                <li class="dropdown messages-menu">
                    ...
                    <li>
                        ...
                        <li><!-- start message -->
                            <a href="#">
                            <div class="pull-left">
                                <img src="{{asset('vendor/dist/img/avatar3.png')}}" class="img-circle" alt="User Image">
                            </div>
                            <h4>
                                Support Team
                        ...
                        <li>
                            <a href="#">
                            <div class="pull-left">
                                <img src="{{asset('vendor/dist/img/user3-128x128.jpg')}}" class="img-circle" alt="User Image">
                            </div>
                            <h4>
                        ...
                        <li>
                            <a href="#">
                            <div class="pull-left">
                                <img src="{{asset('vendor/dist/img/user4-128x128.jpg')}}" class="img-circle" alt="User Image">
                            </div>
                            <h4>
                                Developers
                ...
                @if (Session::has('VENDOR_ID'))
                    @php
                        $vendor = \App\Vendor::where('id', Session::get('VENDOR_ID'))->first();
                    @endphp
                <!-- User Account: style can be found in dropdown.less -->
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                    <img src="{{asset('vendor/dist/img/avatar3.png')}}" class="user-image" alt="User Image">
                    <span class="hidden-xs">{{$vendor->vendorName}}</span>
                    </a>
                    <ul class="dropdown-menu">
                    <!-- User image -->
                    ...
                    <li class="user-footer">
                        ...
                        <div class="pull-right">
                            <form action="{{url('vendor-logout')}}" method="post">
                                {{ csrf_field() }}
        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    {{-- vendor delivery  Start --}}
                    <li class="active">
                        <a href="{{url('vendor-delivery')}}">
                    ...
                    <li class="active">
                        <a href="{{url('rfqs')}}">
                            <i class="fa fa-dashboard"></i> <span>RFQS</span>
                            <span class="pull-right-container">
                            {{-- <i class="fa fa-angle-left pull-right"></i> --}}
                            </span>
                        </a>
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="{{url('/vendor-account-details')}}"><i class="fa fa-circle-o"></i>Account Details</a></li>
                            <li><a href="{{url('/product-provide')}}"><i class="fa fa-circle-o"></i>Type of Product provide</a></li>
                            <li><a href="{{url('/vendor-change-password')}}"><i class="fa fa-circle-o"></i>Change Password</a></li>
                        </ul>
                    </li>
                    {{-- ondemand End --}}
                </ul>
    ...
    <!-- jvectormap -->
    <script src="{{asset('vendor/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js')}}"></script>
    ...
    <!-- Bootstrap WYSIHTML5 -->
    <script src="{{asset('vendor/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js')}}"></script>
    <!-- Slimscroll -->
    ...
    <!-- Select2 -->
    <script src="{{asset('vendor/bower_components/select2/dist/js/select2.full.min.js')}}"></script>
    <!-- CK Editor -->
    ...
    <script src="{{asset('vendor/dist/js/ajaxcrud.js')}}"></script>
