            ...
            <div class="container  theme-container">
                ...
                <div class="breadcrumbs">
                    <div class="breadcrumbs">
                        ...
                        <span><a href="{{url('/cart')}}">Cart</a>  </span>
                        <i class="fa fa-arrow-circle-right"></i>
                ...
                <article itemprop="blogPost">
                    ...
                    <div class="entry-content" itemprop="articleBody">
                        <div class="woocommerce checkout">
                            <form name="checkout" method="post" class="checkout woocommerce-checkout" action="{{url('/order-store')}}" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                        ...
                                        <div class="chck-ttl">
                                            ...
                                            {{-- <table class="shop_table woocommerce-checkout-review-order-table">
                                                ...
                                                @foreach($carts as $cart)
                                                    ...
                                                    @endphp
                                                    <tr class="cart_item">
                                                        <td class="product-name" style="border: black 1px solid; padding-left:25px;">{{$product->productName}} <strong class="product-quantity">&times; {{$cart['qty']}}</strong></td>
                                                        <td class="product-total" style="border: black 1px solid;"><b class="amount">Tk {{number_format($cart['qty'] * $proPrice, 2)}}</b></td>
                                                    </tr>
                                                    @php
                                            ...
                                            <table class="shop_table woocommerce-checkout-review-order-table">
                                                ...
                                                @foreach($carts as $key => $cart)
                                                    ...
                                                    <tr class="">
                                                        ...
                                                        <td class="blk-clr fsz-13" style="padding: 10px;">{{$product->productName}}</td>
                                                        <td class="blk-clr fsz-13" style="padding:10px;">Tk {{number_format($proPrice, 2)}}</td><td class="blk-clr" style="padding: 10px;"> {{$cart['qty']}}</td>
                                                        <td class="blk-clr fsz-13" style="padding:10px;">Tk {{number_format($cart['qty'] * $proPrice, 2)}}</td>
                                                    </tr>
                                                    @php
                                                        $unitPrice = $cart['qty'] * $proPrice;
                                                        $price += $unitPrice;
                                ...
                                <div>
                                    ...
                                    @if ( $advancePayment == false)
                                        <div id="payment" class="col-lg-12 col-sm-6 border woocommerce-checkout-payment text-center">
                                                    ...
                                                    <li class="payment_method_cod">
                                                        <div class="form-check ">
                                                            <label class="radio-inline  mt-30"> 
                                                                <input class="form-control-check" id="cod" type="checkbox" value="1" name="payment_method"> 
