...
@section('og_property')
    ...
    <meta property="og:url" content="{{url('service-by-subcategory/'.$singleSubcategory->id.'/'.str_slug($singleSubcategory->subCategoryName))}}"/>
            ...
            <div class="container text-center">
                ...
                <div class="breadcrumbs">
                    <div class="breadcrumbs text-left">
                        ...
                        <i class="fa fa-arrow-circle-right"></i>
                        <span class="cat-bread"><a href="{{url('service-by-category/'.$singleSubcategory->category->id.'/'.str_slug($singleSubcategory->category->categoryName).'?category_id='.$singleSubcategory->category->id)}}">{{$singleSubcategory->category->categoryName}}</a></span>                        
                                                    ...
                                                    <div class="portfolio-thumb">
                                                        ...
                                                        <div class="portfolio-content">   
                                                            <div class="pop-up-icon">                 
                                                                <a class="center-link quick-view" data-toggle="modal"  data-target="#product-preview" title="Quick View" data-id="{{$serviceGrid->id}}" data-min_order_qty="{{$serviceGrid->min_order_qty}}" data-category="{{$serviceGrid->category->categoryName}}" data-slug="{{$serviceGrid->slug}}" data-name="{{$serviceGrid->productName}}" 
                                                                    data-image="{{asset('/storage/images/product/'.$serviceGrid->image)}}" 
                                                                    ...
                                                                    @else
                                                                        data-regular="{{$serviceGrid->regularPrice}}"
                                                                    @endif  
                                                                    data-url="{{url('product/'.$serviceGrid->id.'/'.$serviceGrid->slug)}}"><i class="fa fa-search"></i></a>
