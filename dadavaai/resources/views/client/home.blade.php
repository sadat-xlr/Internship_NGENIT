                    ...
                    <div class="theme-container container">
                        ...
                        <ul class="nav nav-tabs fsz-13" role="tablist">
                            ...
                            @foreach ($categories->where('categoryName','!=', 'Service & Support') as $P_category)
                                <li><a class="h_cat" href="#p_cat_{{$P_category->id}}" aria-controls="p_cat_{{$P_category->id}}" role="tab" data-toggle="tab" style="padding: 10px 13px !important;">{{$P_category->categoryName}}</a></li>
                            @endforeach 
                    ...
                    <div class="tab-content ">
                                                    ...
                                                    <div class="col-md-12 col-sm-6 col-xs-12">
                                                        <div class="portfolio-wrapper">
                                                            ...
                                                            @endif 
                                                                        ...
                                                                        <a href="#" class="compare left-link addToCompare" data-placement="top" data-url="{{url('addCompare/'.$all_p_cat_product->id)}}" title="Add To Compare">
                                                            ...
                                                            <div class="product-content">
                                                                <h3> 
                                                                    <a class="title-3 fsz-13" href="{{url('product/'.$all_p_cat_product->id.'/'.$all_p_cat_product->slug)}}">
                                                                ...
                                                                <p class="font-2 fsz-10"> 
                                                                    @if ($all_p_cat_product->discount)
                                                                        @if ($all_p_cat_product->deal_id && $all_p_cat_product->deal->valid_until >= \Carbon\Carbon::parse($currentTime)->format('Y-m-d'))
                                                                            <span class="thm-clr fsz-13"> Tk {{number_format($all_p_cat_product->regularPrice-(($all_p_cat_product->regularPrice*($all_p_cat_product->deal->discount_value + $all_p_cat_product->discount))/100))}}</span>    
                                                                            &nbsp; 
                                                                            <span class="thm-clr line-through"> Tk {{number_format($all_p_cat_product->regularPrice)}}</span>   
                                                                        @else
                                                                            <span class="thm-clr fsz-13"> Tk {{number_format($all_p_cat_product->regularPrice-(($all_p_cat_product->regularPrice*$all_p_cat_product->discount)/100))}}</span>
                                                                            &nbsp;
                                                                            <span class="thm-clr line-through"> Tk {{number_format($all_p_cat_product->regularPrice)}}</span>        
                                                                        @endif
                                                                    @else
                                                                        @if ($all_p_cat_product->deal_id && $all_p_cat_product->deal->valid_until >= \Carbon\Carbon::parse($currentTime)->format('Y-m-d'))
                                                                            <span class="thm-clr fsz-13"> Tk {{number_format($all_p_cat_product->regularPrice-(($all_p_cat_product->regularPrice*$all_p_cat_product->deal->discount_value)/100))}}</span>    
                                                                            &nbsp;
                                                                            <span class="thm-clr line-through"> Tk {{number_format($all_p_cat_product->regularPrice)}}</span>   
                                                                        @else
                                                                            <span class="thm-clr fsz-13"> Tk {{number_format($all_p_cat_product->regularPrice)}}</span>    
                                                                        @endif
                                                                    @endif
                        ...
                        @foreach ($categories->where('categoryName','!=', 'Service & Support') as $P_category_panel)
                            <div role="tabpanel" class="tab-pane" id="p_cat_{{$P_category_panel->id}}">
                                <div class="site-tab">
                                    <div class="container">
                                        <!-- Nav tabs for categories minicstegory -->
                                        <ul class="nav nav-tabs fsz-13" role="tablist">
                                            @foreach ($P_category_panel->subcategory as $item)
                                                @foreach ($item->minicategory as $minitem)
                                                    <li><a class="h_minicat" href="#" data-mini_cat_id="{{$minitem->id}}" data-url="{{url('home-product-by-minicategory/'.$minitem->id)}}" aria-controls="p_minicat_{{$minitem->id}}" role="tab" data-toggle="tab" style="padding: 10px 13px !important;">{{$minitem->miniCategoryName}}</a></li>
                                                @endforeach
                                            @endforeach
                                            <li class="active"><a class="h_minicat_all" href="#all_p_minicat_{{$P_category_panel->id}}" aria-controls="all_p_minicat" role="tab" data-toggle="tab">ALL</a></li>
                                        </ul>
                                        <!-- tab panel  for categorie's minicstegory product -->
                                        <div class="all_p_minicat_products mt-5">
                                            @if (count($P_category_panel->product) >0)

                                                <!-- Portfolio items -->
                                                @foreach ($P_category_panel->product->where('published', false)->take(9) as $P_category_panel_product)
                                                    <div class="col-md-3 col-sm-6 col-xs-12 w-20">
                                                        <div class="portfolio-wrapper">
                                                            <div class="portfolio-thumb">
                                                                ...
                                                                <div class="portfolio-content">                                            
                                                                    <div class="pop-up-icon">                 
                                                                        ...
                                                                        <a href="#" class="compare left-link addToCompare" data-placement="top" data-url="{{url('addCompare/'.$P_category_panel_product->id)}}" title="Add To Compare">
                                                                            <i class="fa fa-retweet"></i>
                                                                        </a>
                                                            ...
                                                            <div class="product-content">
                                                                <h3> 
                                                                    <a class="title-3 fsz-13" href="{{url('product/'.$P_category_panel_product->id.'/'.$P_category_panel_product->slug)}}">
                                                                        {{substr($P_category_panel_product->productName, 0, 26)}}
                                                                    </a> 
                                                                </h3>
                                                                <p class="font-2 fsz-10">
                                                                    @if ($P_category_panel_product->discount)
                                                                        @if ($P_category_panel_product->deal_id && $P_category_panel_product->deal->valid_until >= \Carbon\Carbon::parse($currentTime)->format('Y-m-d'))
                                                                            <span class="thm-clr fsz-13"> Tk {{number_format($P_category_panel_product->regularPrice-(($P_category_panel_product->regularPrice*($P_category_panel_product->deal->discount_value + $P_category_panel_product->discount))/100))}}</span>
                                                                            &nbsp;    
                                                                            <span class="thm-clr line-through"> Tk {{number_format($P_category_panel_product->regularPrice)}}</span>   
                                                                        @else
                                                                            <span class="thm-clr fsz-13"> Tk {{number_format($P_category_panel_product->regularPrice-(($P_category_panel_product->regularPrice*$P_category_panel_product->discount)/100))}}</span>
                                                                            &nbsp; 
                                                                            <span class="thm-clr line-through"> Tk {{number_format($P_category_panel_product->regularPrice)}}</span>        
                                                                        @endif
                                                                    @else
                                                                        @if ($P_category_panel_product->deal_id && $P_category_panel_product->deal->valid_until >= \Carbon\Carbon::parse($currentTime)->format('Y-m-d'))
                                                                            <span class="thm-clr fsz-13"> Tk {{number_format($P_category_panel_product->regularPrice-(($P_category_panel_product->regularPrice*$P_category_panel_product->deal->discount_value)/100))}}</span> 
                                                                            &nbsp;    
                                                                            <span class="thm-clr line-through"> Tk {{number_format($P_category_panel_product->regularPrice)}}</span>   
                                                                        @else
                                                                            <span class="thm-clr fsz-13"> Tk {{number_format($P_category_panel_product->regularPrice)}}</span>    
                                                                        @endif
                                                                    @endif
                                                ...
                                                <div class="col-md-3 col-sm-6 col-xs-12 w-20">
                                                    <div class="portfolio-wrapper">
                                                        <div class="product-content">
                                                            <a href="{{url('product-by-category/'.$P_category_panel->id.'/'.str_slug($P_category_panel->categoryName))}}">
                                                                <img src="{{asset('client/img/extra/view_all.jpg')}}" alt="">
                                                            </a>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="all_p_minicat_ajax mt-5">
                            ...
                            @foreach ($offer->products as $offerProduct)
                                <div class="product">
                                    ...
                                    <div class="product-content text-center">
                                        <a class="" href="{{url('product/'.$offerProduct->id.'/'.$offerProduct->slug)}}" class="fsz-13"> 
                                            <span class="" style="font-size:12px;!important">{{substr($offerProduct->productName, 0, 26)}}</span> 
                                        </a>
                                        <p class="font-2 fsz-10">
                                            @if ($offerProduct->discount)
                                                @if ($offerProduct->deal_id && $offerProduct->deal->valid_until >= \Carbon\Carbon::parse($currentTime)->format('Y-m-d'))
                                                    <span class="thm-clr fsz-13">
                                            ...
                                            @else
                                                @if ($offerProduct->deal_id && $offerProduct->deal->valid_until >= \Carbon\Carbon::parse($currentTime)->format('Y-m-d'))
                                                    ...
                                                    <span class="thm-clr line-through"> Tk {{number_format($offerProduct->regularPrice)}}</span>   
                                                @else
                                                    <span class="thm-clr fsz-13"> Tk {{number_format($offerProduct->regularPrice,2)}}</span>    
                                                @endif
                                            @endif
                                        </p>    
                                    </div>
                ...
                <div class="gst-column col-lg-12 no-padding text-center">
                    ...
                    <div class="theme-container container">
                        ...
                        <ul class="nav nav-tabs fsz-13" role="tablist">
                          ...
                          <li><a href="#combo_dis" aria-controls="combo_dis" role="tab" data-toggle="tab">COMBO</a></li>
                    ...
                    <div class="tab-content ">
                                        ...
                                        <div class="col-md-3 col-sm-6 col-xs-12 w-20">
                                            <div class="portfolio-wrapper">
                                                ...
                                                @endif 
                                                            ...
                                                            <a href="#" class="compare left-link addToCompare" data-placement="top" data-url="{{url('addCompare/'.$allSpecialDiscountProduct->id)}}" title="Add To Compare">
                                                                <i class="fa fa-retweet"></i>
                                                            </a>
                                                ...
                                                <div class="product-content">
                                                    <h3> 
                                                        <a class="title-3 fsz-13" href="{{url('product/'.$allSpecialDiscountProduct->id.'/'.$allSpecialDiscountProduct->slug)}}">
                                                            {{substr($allSpecialDiscountProduct->productName, 0, 26)}}
                                                        </a> 
                                                    </h3>
                                                    <p class="font-2 fsz-10"> 
                                                        @if ($allSpecialDiscountProduct->discount)
                                                            @if ($allSpecialDiscountProduct->deal_id && $allSpecialDiscountProduct->deal->valid_until >= \Carbon\Carbon::parse($currentTime)->format('Y-m-d'))
                                                                <span class="thm-clr fsz-13"> Tk {{number_format($allSpecialDiscountProduct->regularPrice-(($allSpecialDiscountProduct->regularPrice*($allSpecialDiscountProduct->deal->discount_value + $allSpecialDiscountProduct->discount))/100), 2)}}</span>    
                                                                <span class="thm-clr line-through"> Tk {{number_format($allSpecialDiscountProduct->regularPrice, 2)}}</span>   
                                                            @else
                                                                <span class="thm-clr fsz-13"> Tk {{number_format($allSpecialDiscountProduct->regularPrice-(($allSpecialDiscountProduct->regularPrice*$allSpecialDiscountProduct->discount)/100), 2)}}</span>
                                                                <span class="thm-clr line-through"> Tk {{number_format($allSpecialDiscountProduct->regularPrice, 2)}}</span>        
                                                            @endif
                                                        @else
                                                            @if ($allSpecialDiscountProduct->deal_id && $allSpecialDiscountProduct->deal->valid_until >= \Carbon\Carbon::parse($currentTime)->format('Y-m-d'))
                                                                <span class="thm-clr fsz-13"> Tk {{number_format($allSpecialDiscountProduct->regularPrice-(($allSpecialDiscountProduct->regularPrice*$allSpecialDiscountProduct->deal->discount_value)/100), 2)}}</span>    
                                                                <span class="thm-clr line-through"> Tk {{number_format($allSpecialDiscountProduct->regularPrice, 2)}}</span>   
                                                            @else
                                                                <span class="thm-clr fsz-13"> Tk {{number_format($allSpecialDiscountProduct->regularPrice, 2)}}</span>    
                                                            @endif
                                                        @endif
                                                        <a href="#" class="compare-add-to-cart right-link addCart" data-placement="top" data-slug="{{$allSpecialDiscountProduct->slug}}" title="Add To Cart" data-id="{{$allSpecialDiscountProduct->id}}" data-url="{{url('/add-cart')}}" data-qty="1"><i class="fa fa-shopping-cart"></i></a>
                                                        <a class="compare-add-to-cart left-link addWishlist" href="#" data-placement="top" data-slug="{{$allSpecialDiscountProduct->slug}}" title="Add To Wishlist" data-id="{{$allSpecialDiscountProduct->id}}" data-url="{{url('/add-to-wishlist')}}"><i class="fa fa-heart"></i></a>
                                                    </p>    
                                                </div>
                                            </div>
                                        </div>                                     
                                        ...
                                        <div class="col-md-3 col-sm-6 col-xs-12 w-20">
                                            <div class="portfolio-wrapper">
                                                ...
                                                @endif  
                                                            ...
                                                            <a href="#" class="compare left-link addToCompare" data-placement="top" data-url="{{url('addCompare/'.$buyGetProduct->id)}}" title="Add To Compare">
                                                                <i class="fa fa-retweet"></i>
                                                            </a>
                                                ...
                                                <div class="product-content">
                                                    <h3> 
                                                        <a class="title-3 fsz-13" href="{{url('product/'.$buyGetProduct->id.'/'.$buyGetProduct->slug)}}">
                                                            {{substr($buyGetProduct->productName, 0, 26)}}
                                                        </a> 
                                                    </h3>
                                                    <p class="font-2 fsz-10">
                                                        @if ($buyGetProduct->discount)
                                                            @if ($buyGetProduct->deal_id && $buyGetProduct->deal->valid_until >= \Carbon\Carbon::parse($currentTime)->format('Y-m-d'))
                                                                <span class="thm-clr fsz-13"> Tk {{number_format($buyGetProduct->regularPrice-(($buyGetProduct->regularPrice*($buyGetProduct->deal->discount_value + $buyGetProduct->discount))/100), 2)}}</span>    
                                                                <span class="thm-clr line-through"> Tk {{number_format($buyGetProduct->regularPrice, 2)}}</span>   
                                                            @else
                                                                <span class="thm-clr fsz-13"> Tk {{number_format($buyGetProduct->regularPrice-(($buyGetProduct->regularPrice*$buyGetProduct->discount)/100), 2)}}</span>
                                                                <span class="thm-clr line-through"> Tk {{number_format($buyGetProduct->regularPrice, 2)}}</span>        
                                                            @endif
                                                        @else
                                                            @if ($buyGetProduct->deal_id && $buyGetProduct->deal->valid_until >= \Carbon\Carbon::parse($currentTime)->format('Y-m-d'))
                                                                <span class="thm-clr fsz-13"> Tk {{number_format($buyGetProduct->regularPrice-(($buyGetProduct->regularPrice*$buyGetProduct->deal->discount_value)/100), 2)}}</span>    
                                                                <span class="thm-clr line-through"> Tk {{number_format($buyGetProduct->regularPrice, 2)}}</span>   
                                                            @else
                                                                <span class="thm-clr fsz-13"> Tk {{number_format($buyGetProduct->regularPrice, 2)}}</span>    
                                                            @endif
                                                        @endif
                                                        <a href="#" class="compare-add-to-cart right-link addCart" data-placement="top" data-slug="{{$buyGetProduct->slug}}" title="Add To Cart" data-id="{{$buyGetProduct->id}}" data-url="{{url('/add-cart')}}" data-qty="1"><i class="fa fa-shopping-cart"></i></a>
                                                        <a class="compare-add-to-cart left-link addWishlist" href="#" data-placement="top" data-slug="{{$buyGetProduct->slug}}" title="Add To Wishlist" data-id="{{$buyGetProduct->id}}" data-url="{{url('/add-to-wishlist')}}"><i class="fa fa-heart"></i></a>
                                                    </p>    
                                                </div>
                                            </div>
                                        </div>                                     
                                        ...
                                        <div class="col-md-3 col-sm-6 col-xs-12 w-20">
                                            <div class="portfolio-wrapper">
                                                ...
                                                @endif 
                                                            ...
                                                            <a href="#" class="compare left-link addToCompare" data-placement="top" data-url="{{url('addCompare/'.$occasionProduct->id)}}" title="Add To Compare">
                                                                <i class="fa fa-retweet"></i>
                                                            </a>
                                                ...
                                                <div class="product-content">
                                                    <h3> 
                                                        <a class="title-3 fsz-13" href="{{url('product/'.$occasionProduct->id.'/'.$occasionProduct->slug)}}">
                                                            {{substr($occasionProduct->productName, 0, 26)}}
                                                        </a> 
                                                    </h3>
                                                    <p class="font-2 fsz-10"> 
                                                        @if ($occasionProduct->discount)
                                                            @if ($occasionProduct->deal_id && $occasionProduct->deal->valid_until >= \Carbon\Carbon::parse($currentTime)->format('Y-m-d'))
                                                                <span class="thm-clr fsz-13"> Tk {{number_format($occasionProduct->regularPrice-(($occasionProduct->regularPrice*($occasionProduct->deal->discount_value + $occasionProduct->discount))/100), 2)}}</span>    
                                                                <span class="thm-clr line-through"> Tk {{number_format($occasionProduct->regularPrice, 0)}}</span>   
                                                            @else
                                                                <span class="thm-clr fsz-13"> Tk {{number_format($occasionProduct->regularPrice-(($occasionProduct->regularPrice*$occasionProduct->discount)/100), 2)}}</span>
                                                                <span class="thm-clr line-through"> Tk {{number_format($occasionProduct->regularPrice, 0)}}</span>        
                                                            @endif
                                                        @else
                                                            @if ($occasionProduct->deal_id && $occasionProduct->deal->valid_until >= \Carbon\Carbon::parse($currentTime)->format('Y-m-d'))
                                                                <span class="thm-clr fsz-13"> Tk {{number_format($occasionProduct->regularPrice-(($occasionProduct->regularPrice*$occasionProduct->deal->discount_value)/100), 2)}}</span>    
                                                                <span class="thm-clr line-through"> Tk {{number_format($occasionProduct->regularPrice, 0)}}}</span>   
                                                            @else
                                                                <span class="thm-clr fsz-13"> Tk {{number_format($occasionProduct->regularPrice, 0)}}</span>    
                                                            @endif
                                                        @endif
                                                        <a href="#" class="compare-add-to-cart right-link addCart" data-placement="top" data-slug="{{$occasionProduct->slug}}" title="Add To Cart" data-id="{{$occasionProduct->id}}" data-url="{{url('/add-cart')}}" data-qty="1"><i class="fa fa-shopping-cart"></i></a>
                                                        <a class="compare-add-to-cart left-link addWishlist" href="#" data-placement="top" data-slug="{{$occasionProduct->slug}}" title="Add To Wishlist" data-id="{{$occasionProduct->id}}" data-url="{{url('/add-to-wishlist')}}"><i class="fa fa-heart"></i></a>
                                                    </p>    
                                                </div>
                                            </div>
                                        </div>                                     
                                        ...
                                        <div class="col-md-3 col-sm-6 col-xs-12 w-20">
                                            <div class="portfolio-wrapper">
                                                ...
                                                @endif 
                                                            ...
                                                            <a href="#" class="compare left-link addToCompare" data-placement="top" data-url="{{url('addCompare/'.$promotionProduct->id)}}" title="Add To Compare">
                                                                <i class="fa fa-retweet"></i>
                                                            </a>
                                                ...
                                                <div class="product-content">
                                                    <h3> 
                                                        <a class="title-3 fsz-13" href="{{url('product/'.$promotionProduct->id.'/'.$promotionProduct->slug)}}">
                                                            {{substr($promotionProduct->productName, 0, 26)}}
                                                        </a> 
                                                    </h3>
                                                    <p class="font-2 fsz-10"> 
                                                        @if ($promotionProduct->discount)
                                                            @if ($promotionProduct->deal_id && $promotionProduct->deal->valid_until >= \Carbon\Carbon::parse($currentTime)->format('Y-m-d'))
                                                                <span class="thm-clr fsz-13"> Tk {{number_format($promotionProduct->regularPrice-(($promotionProduct->regularPrice*($promotionProduct->deal->discount_value + $promotionProduct->discount))/100), 2)}}</span>    
                                                                <span class="thm-clr line-through"> Tk {{number_format($promotionProduct->regularPrice, 2)}}</span>   
                                                            @else
                                                                <span class="thm-clr fsz-13"> Tk {{number_format($promotionProduct->regularPrice-(($promotionProduct->regularPrice*$promotionProduct->discount)/100), 2)}}</span>
                                                                <span class="thm-clr line-through"> Tk {{number_format($promotionProduct->regularPrice, 2)}}</span>        
                                                            @endif
                                                        @else
                                                            @if ($promotionProduct->deal_id && $promotionProduct->deal->valid_until >= \Carbon\Carbon::parse($currentTime)->format('Y-m-d'))
                                                                <span class="thm-clr fsz-13"> Tk {{number_format($promotionProduct->regularPrice-(($promotionProduct->regularPrice*$promotionProduct->deal->discount_value)/100), 2)}}</span>    
                                                                <span class="thm-clr line-through"> Tk {{number_format($promotionProduct->regularPrice, 2)}}</span>   
                                                            @else
                                                                <span class="thm-clr fsz-13"> Tk {{number_format($promotionProduct->regularPrice, 2)}}</span>    
                                                            @endif
                                                        @endif
                                                        <a href="#" class="compare-add-to-cart right-link addCart" data-placement="top" data-slug="{{$promotionProduct->slug}}" title="Add To Cart" data-id="{{$promotionProduct->id}}" data-url="{{url('/add-cart')}}" data-qty="1"><i class="fa fa-shopping-cart"></i></a>
                                                        <a class="compare-add-to-cart left-link addWishlist" href="#" data-placement="top" data-slug="{{$promotionProduct->slug}}" title="Add To Wishlist" data-id="{{$promotionProduct->id}}" data-url="{{url('/add-to-wishlist')}}"><i class="fa fa-heart"></i></a>
                                                    </p>    
                                                </div>
                                            </div>
                                        </div>                                     
                                    ...
                                    @foreach ($clearanceProducts as $clearanceProduct)
                                        <div class="col-md-3 col-sm-6 col-xs-12 w-20">
                                            <div class="portfolio-wrapper">
                                                <div class="portfolio-thumb">
                                                    ...
                                                    <div class="portfolio-content">                                            
                                                        ...
                                                        @endif 
                                                            ...
                                                            <a href="#" class="compare left-link addToCompare" data-placement="top" data-url="{{url('addCompare/'.$clearanceProduct->id)}}" title="Add To Compare">
                                                                <i class="fa fa-retweet"></i>
                                                            </a>
                                                ...
                                                <div class="product-content">
                                                    <h3> 
                                                        <a class="title-3 fsz-13" href="{{url('product/'.$clearanceProduct->id.'/'.$clearanceProduct->slug)}}">
                                                            {{substr($clearanceProduct->productName, 0, 26)}}
                                                        </a> 
                                                    </h3>
                                                    <p class="font-2 fsz-10"> 
                                                        @if ($clearanceProduct->discount)
                                                            @if ($clearanceProduct->deal_id && $clearanceProduct->deal->valid_until >= \Carbon\Carbon::parse($currentTime)->format('Y-m-d'))
                                                                <span class="thm-clr fsz-13"> Tk {{number_format($clearanceProduct->regularPrice-(($clearanceProduct->regularPrice*($clearanceProduct->deal->discount_value + $clearanceProduct->discount))/100), 2)}}</span>    
                                                                <span class="thm-clr line-through"> Tk {{number_format($clearanceProduct->regularPrice, 2)}}</span>   
                                                            @else
                                                                <span class="thm-clr fsz-13"> Tk {{number_format($clearanceProduct->regularPrice-(($clearanceProduct->regularPrice*$clearanceProduct->discount)/100), 2)}}</span>
                                                                <span class="thm-clr line-through"> Tk {{number_format($clearanceProduct->regularPrice, 2)}}</span>        
                                                            @endif
                                                        @else
                                                            @if ($clearanceProduct->deal_id && $clearanceProduct->deal->valid_until >= \Carbon\Carbon::parse($currentTime)->format('Y-m-d'))
                                                                <span class="thm-clr fsz-13"> Tk {{number_format($clearanceProduct->regularPrice-(($clearanceProduct->regularPrice*$clearanceProduct->deal->discount_value)/100), 2)}}</span>    
                                                                <span class="thm-clr line-through"> Tk {{number_format($clearanceProduct->regularPrice, 2)}}</span>   
                                                            @else
                                                                <span class="thm-clr fsz-13"> Tk {{number_format($clearanceProduct->regularPrice, 2)}}</span>    
                                                            @endif
                                                        @endif
                                                        <a href="#" class="compare-add-to-cart right-link addCart" data-placement="top" data-slug="{{$clearanceProduct->slug}}" title="Add To Cart" data-id="{{$clearanceProduct->id}}" data-url="{{url('/add-cart')}}" data-qty="1"><i class="fa fa-shopping-cart"></i></a>
                                                        <a class="compare-add-to-cart left-link addWishlist" href="#" data-placement="top" data-slug="{{$clearanceProduct->slug}}" title="Add To Wishlist" data-id="{{$clearanceProduct->id}}" data-url="{{url('/add-to-wishlist')}}"><i class="fa fa-heart"></i></a>
                                                    </p>    
                                                </div>
                                            </div>
                                        </div>                                     
                        ...
                        <div role="tabpanel" class="tab-pane" id="combo_dis">
                            <div class="site-tab">
                                <div class="container text-center">
                                    <!-- Portfolio items -->
                                    @foreach ($comboProducts as $comboProduct)
                                        <div class="col-md-3 col-sm-6 col-xs-12 w-20">
                                            <div class="portfolio-wrapper">
                                                <div class="portfolio-thumb">
                                                    ...
                                                    <div class="portfolio-content">                                            
                                                        <div class="pop-up-icon">                 
                                                            ...
                                                            <a href="#" class="compare left-link addToCompare" data-placement="top" data-url="{{url('addCompare/'.$comboProduct->id)}}" title="Add To Compare">
                                                                <i class="fa fa-retweet"></i>
                                                            </a>
                                                ...
                                                <div class="product-content">
                                                    <h3> 
                                                        <a class="title-3 fsz-13" href="{{url('product/'.$comboProduct->id.'/'.$comboProduct->slug)}}">
                                                            {{substr($comboProduct->productName, 0, 26)}}
                                                        </a> 
                                                    </h3>
                                                    <p class="font-2 fsz-10"> 
                                                        @if ($comboProduct->discount)
                                                            @if ($comboProduct->deal_id && $comboProduct->deal->valid_until >= \Carbon\Carbon::parse($currentTime)->format('Y-m-d'))
                                                                <span class="thm-clr fsz-13"> Tk {{number_format($comboProduct->regularPrice-(($comboProduct->regularPrice*($comboProduct->deal->discount_value + $comboProduct->discount))/100), 2)}}</span>    
                                                                <span class="thm-clr line-through"> Tk {{number_format($comboProduct->regularPrice, 2)}}</span>   
                                                            @else
                                                                <span class="thm-clr fsz-13"> Tk {{number_format($comboProduct->regularPrice-(($comboProduct->regularPrice*$comboProduct->discount)/100), 2)}}</span>
                                                                <span class="thm-clr line-through"> Tk {{number_format($comboProduct->regularPrice, 2)}}</span>        
                                                            @endif
                                                        @else
                                                            @if ($comboProduct->deal_id && $comboProduct->deal->valid_until >= \Carbon\Carbon::parse($currentTime)->format('Y-m-d'))
                                                                <span class="thm-clr fsz-13"> Tk {{number_format($comboProduct->regularPrice-(($comboProduct->regularPrice*$comboProduct->deal->discount_value)/100), 2)}}</span>    
                                                                <span class="thm-clr line-through"> Tk {{number_format($comboProduct->regularPrice, 2)}}</span>   
                                                            @else
                                                                <span class="thm-clr fsz-13"> Tk {{number_format($comboProduct->regularPrice, 2)}}</span>    
                                                            @endif
                                                        @endif
                                                        <a href="#" class="compare-add-to-cart right-link addCart" data-placement="top" data-slug="{{$comboProduct->slug}}" title="Add To Cart" data-id="{{$comboProduct->id}}" data-url="{{url('/add-cart')}}" data-qty="1"><i class="fa fa-shopping-cart"></i></a>
                                                        <a class="compare-add-to-cart left-link addWishlist" href="#" data-placement="top" data-slug="{{$comboProduct->slug}}" title="Add To Wishlist" data-id="{{$comboProduct->id}}" data-url="{{url('/add-to-wishlist')}}"><i class="fa fa-heart"></i></a>
                                                    </p>    
                                                </div>
                                            </div>
                                        </div>                                     
                            ...
                            @foreach ($categoryP->product->where('published', false)->sortByDesc('created_at')->take(2) as $newArrival)
                                <div class="col-md-3 col-sm-6 col-xs-12 isotope-item tab-1 tab-{{$categoryP->id + 1}} w-20">
                                    <div class="portfolio-wrapper">
                                        <div class="portfolio-thumb">
                                            ...
                                            <div class="portfolio-content">                                            
                                                ...
                                                @endif 
                                                    ...
                                                    <a href="#" class="compare left-link addToCompare" data-placement="top" data-url="{{url('addCompare/'.$newArrival->id)}}" title="Add To Compare">
                                                        <i class="fa fa-retweet"></i>
                                                    </a>
                                        ...
                                        <div class="product-content">
                                            <h3> 
                                                <a class="title-3 fsz-13" href="{{url('product/'.$newArrival->id.'/'.$newArrival->slug)}}">
                                                    {{substr($newArrival->productName, 0, 30)}}
                                                </a> 
                                            </h3>
                                            <p class="font-2 fsz-10">
                                                @if ($newArrival->discount)
                                                ...
                                                @else
                                                    @if ($newArrival->deal_id && $newArrival->deal->valid_until >= \Carbon\Carbon::parse($currentTime)->format('Y-m-d'))
                                                        ...
                                                        <span class="thm-clr line-through"> Tk {{number_format($newArrival->regularPrice), 2}}</span>   
                                                    @else
                                                        <span class="thm-clr fsz-13"> Tk {{number_format($newArrival->regularPrice), 2}}</span>    
                                                    @endif
                                                @endif  
                                                <a href="#" class="compare-add-to-cart right-link addCart" data-placement="top" data-slug="{{$newArrival->slug}}" title="Add To Cart" data-id="{{$newArrival->id}}" data-url="{{url('/add-cart')}}" data-qty="1"><i class="fa fa-shopping-cart"></i></a>
                                                <a class="compare-add-to-cart left-link addWishlist" href="#" data-placement="top" data-slug="{{$newArrival->slug}}" title="Add To Wishlist" data-id="{{$newArrival->id}}" data-url="{{url('/add-to-wishlist')}}"><i class="fa fa-heart"></i></a>
                                            </p>    
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        @foreach ($topMostDeal->products as $topMostDealProduct)
                                            <div class="col-md-3 col-sm-6 col-xs-12 isotope-item tab-2 w-20">
                                                <div class="portfolio-wrapper">
                                                    <div class="portfolio-thumb">
                                                        ...
                                                        <div class="portfolio-content">                                            
                                                            <div class="pop-up-icon">                 
                                                                ...
                                                                <a href="#" class="compare left-link addToCompare" data-placement="top" data-url="{{url('addCompare/'.$topMostDealProduct->id)}}" title="Add To Compare">
                                                                    <i class="fa fa-retweet"></i>
                                                                </a>
                                                    ...
                                                    <div class="product-content">
                                                        <h3> 
                                                            <a class="title-3 fsz-13" href="{{url('product/'.$topMostDealProduct->id.'/'.$topMostDealProduct->slug)}}">
                                                                {{substr($topMostDealProduct->productName, 0, 26)}}
                                                            </a> 
                                                        </h3>
                                                        <p class="font-2 fsz-10">
                                                            @if ($topMostDealProduct->discount)
                                                            ...
                                                            @else
                                                                @if ($topMostDealProduct->deal_id && $topMostDealProduct->deal->valid_until >= \Carbon\Carbon::parse($currentTime)->format('Y-m-d'))
                                                                    ...
                                                                    <span class="thm-clr line-through"> Tk {{number_format($topMostDealProduct->regularPrice, 2)}}</span>   
                                                                @else
                                                                    <span class="thm-clr fsz-13"> Tk {{number_format($topMostDealProduct->regularPrice, 2)}}</span>    
                                                                @endif
                                                            @endif 
                                                            <a href="#" class="compare-add-to-cart right-link addCart" data-placement="top" data-slug="{{$topMostDealProduct->slug}}" title="Add To Cart" data-id="{{$topMostDealProduct->id}}" data-url="{{url('/add-cart')}}" data-qty="1"><i class="fa fa-shopping-cart"></i></a>
                                                            <a class="compare-add-to-cart left-link addWishlist" href="#" data-placement="top" data-slug="{{$topMostDealProduct->slug}}" title="Add To Wishlist" data-id="{{$topMostDealProduct->id}}" data-url="{{url('/add-to-wishlist')}}"><i class="fa fa-heart"></i></a>
                                                        </p>    
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        @foreach ($deal->products as $dealProduct)
                                            <div class="col-md-3 col-sm-6 col-xs-12 w-20">
                                                <div class="portfolio-wrapper">
                                                    <div class="portfolio-thumb">
                                                        ...
                                                        <div class="portfolio-content">                                            
                                                            <div class="pop-up-icon">                 
                                                                ...
                                                                <a href="#" class="compare left-link addToCompare" data-placement="top" data-url="{{url('addCompare/'.$dealProduct->id)}}" title="Add To Compare">
                                                                    <i class="fa fa-retweet"></i>
                                                                </a>
                                                    ...
                                                    <div class="product-content">
                                                        <h3> 
                                                            <a class="title-3 fsz-13" href="{{url('product/'.$dealProduct->id.'/'.$dealProduct->slug)}}">
                                                                {{substr($dealProduct->productName, 0,26)}}
                                                            </a> 
                                                        </h3>
                                                        <p class="font-2 fsz-10">
                                                            @if ($dealProduct->discount)
                                                                @if ($dealProduct->deal_id && $dealProduct->deal->valid_until >= \Carbon\Carbon::parse($currentTime)->format('Y-m-d'))
                                                                    <span class="thm-clr fsz-13">
                                                                        Tk {{number_format($dealProduct->regularPrice-(($dealProduct->regularPrice*($dealProduct->deal->discount_value + $dealProduct->discount))/100))}}
                                                                    </span>    
                                                                    <span class="thm-clr line-through"> Tk {{number_format($dealProduct->regularPrice)}}</span>   
                                                                @else
                                                                    <span class="thm-clr fsz-13">
                                                                        Tk {{number_format($dealProduct->regularPrice-(($dealProduct->regularPrice*$dealProduct->discount)/100))}}
                                                                    </span>
                                                                    <span class="thm-clr line-through"> Tk {{number_format($dealProduct->regularPrice)}}</span>
                                                                @endif
                                                            @else
                                                                @if ($dealProduct->deal_id && $dealProduct->deal->valid_until >= \Carbon\Carbon::parse($currentTime)->format('Y-m-d'))
                                                                    <span class="thm-clr fsz-13"> 
                                                                        Tk {{number_format($dealProduct->regularPrice-(($dealProduct->regularPrice*$dealProduct->deal->discount_value)/100))}}
                                                                    </span>    
                                                                    <span class="thm-clr line-through"> Tk {{number_format($dealProduct->regularPrice, 2)}}</span>   
                                                                @else
                                                                    <span class="thm-clr fsz-13"> Tk {{number_format($dealProduct->regularPrice)}}</span>    
                                                                @endif
                                                            @endif
                                                            <a href="#" class="compare-add-to-cart right-link addCart" data-placement="top" data-slug="{{$dealProduct->slug}}" title="Add To Cart" data-id="{{$dealProduct->id}}" data-url="{{url('/add-cart')}}" data-qty="1"><i class="fa fa-shopping-cart"></i></a>
                                                            <a class="compare-add-to-cart left-link addWishlist" href="#" data-placement="top" data-slug="{{$dealProduct->slug}}" title="Add To Wishlist" data-id="{{$dealProduct->id}}" data-url="{{url('/add-to-wishlist')}}"><i class="fa fa-heart"></i></a>  
                                                        </p>    
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="col-lg-3 pt-45">
                                <div class="col-lg-12 col-md-12 col-sm-12 menu-block mb-3" style="padding: 5px;">
                                    <div class="sub-list text-left">
                                        <div class="menu-card" style="height: 250px; border: #999 1px solid; border-radius: 0px;">
                                            <a href="{{url('pre-launching-product-details/'.$prebook->id)}}">
                                                <img src="{{asset('storage/images/product/'.$prebook->product->image->image1)}}" alt="" height="100%" width="100%"/>
                                            </a>
                                        </div>
                                        <div class="p-4" style="background: #f7f5f5;">
                                            <div>
                                                <a class="fsz-12" href="{{url('product-by-category/'.$prebook->product->category->id.'/'.str_slug($prebook->product->category->categoryName))}}">
                                                    {{$prebook->product->category->categoryName}}
                                                </a>
                                                <a class="right addWishlist" href="#" data-placement="top" data-slug="{{$prebook->product->slug}}" title="Add To Wishlist" data-id="{{$prebook->product->id}}" data-url="{{url('/add-to-wishlist')}}">
                                                    <i class="fa fa-heart-o"></i>
                                                </a>
                                            </div>
                                            <div class="fsz-14 title-3 mt-5">
                                                <a href="{{url('pre-launching-product-details/'.$prebook->id)}}">
                                                    {{substr($prebook->product->productName, 0, 30)}}
                                                </a>
                                            </div>
                                            <div class="" style="line-height: 15px;"> 
                                                <a class="fsz-12 text-justify" href="{{url('pre-launching-product-details/'.$prebook->id)}}" rel="bookmark">
                                                    {{ substr(strip_tags($prebook->details),0,80)}}
                                                </a>
                                            ...
                                            <div class="fsz-12">
                                                ...
                                                <a href="#" class="right"> Save now {{number_format(( $prebook->prebook_discount*100/$prebook->product->regularPrice))}}%</a>
                                                <hr style="padding: unset; margin:unset;border-top: 3px solid #d02121;">
                                            </div>
                                            <div class="fsz-12">
                                                <i class="fa fa-clock-o" aria-hidden="true"></i>
                                                <span>
                                                    {{ \Carbon\Carbon::parse($prebook->launching_date)->diffForHumans(null, true).' left' }}
                                                </span>
                                                <span class="right">
                                            ...
                                            <div class="mt-15 mb-10 text-center">
                                                <a class="fancy-btn fancy-btn-small" href="{{url('prebook-form/'.$prebook->id)}}" data-placement="top" title="Book now">
                                                    <i class="fa fa-shopping-cart"></i> &nbsp; PreBook 
                                                </a>
                                            </div>
                                        </div>
                                        <br>
...
// })
 ...
 $('.owl-carousel-all-product').owlCarousel({
     loop:($('.owl-carousel-all-product').children().length)==5 ? false:true,
     margin:5,
