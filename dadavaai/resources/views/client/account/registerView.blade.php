        ...
        <div class="main-wrapper clearfix">
            ...
            <div class="theme-container container">
                <div class="gst-spc3 row">
                    ...
                    <main id="signup_form" class="col-lg-6 col-md-8 col-sm-6 col-lg-offset-3 col-md-offset-2  blog-wrap">
                    ...
                    <main id="signin_form" class="col-lg-6 col-md-8 col-sm-6 col-lg-offset-3 col-md-offset-2 hide">
                        <article class="" itemscope="itemscope" itemtype="http://schema.org/BlogPosting" itemprop="blogPost">
                            <div class="account-details-wrap">
                                <div class="heading-2">                                
