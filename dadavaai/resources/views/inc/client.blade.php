                    ...
                    <ul class="pull-right list-unstyled list-inline">
                        <li class="nav-dropdown">
                            ...
                            <ul class="nav-dropdown-inner list-unstyled accnt-list" style="margin-top: -5px;">
                                ...
                                <li> <a href="{{url('/client-login-register')}}">User Registration</a></li>
        ...
        <div class="header-wrap mt--35" style="border-bottom: solid 1px #cacaca;">
            <div class="container theme-container reltv-div ">   
                <div class="row">
                    ...
                    <!-- search box start -->
                    <div class="col-lg-6 col-md-6 col-sm-12 static-div">
                    ...
                    <div class="col-md-3 col-sm-3 left">
                        ...
                        <span id="cartContent" class="cartContent">
                            ...
                            <div id="miniCartView" class="cartView" style="top: 80px;left: -100%;">
                                @if ($carts)
                                    {{-- cart item --}}
...
{{--     <section class="subscribe-me">
 ...
 --}}    <!-- / Subscribe Popup 1 -->
            ...
            <div class="modal-content login-1 wht-clr">   
                <div class="login-wrap text-center">                        
                    ...
                    <div class="login-form">
                        ...
                        <a  href="{{url('client-login-register')}}" class="wht-clr fsz-12"> <u>If you are not a member, click here to register </u></a>
    ...
    <!-- Popup: chat  -->
    <div class="modal fade login-popup" id="chat-popup" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg">                
            <button type="button" class="close close-btn popup-cls" data-dismiss="modal" aria-label="Close"> <i class="fa-times fa"></i> </button>
            ...
            <div class="modal-content">   
                <div class="login-wrap text-center">                        
                    <div class="chat-form">
                        <p class="bold-font-2 fsz-12 signup"> Chat Now </p>
                        ...
                        <form class="chat" method="GET">
                            ...
                            <div class="form-group">
                                <input type="password" id="password" name="password" placeholder="Password" class="form-control" style="text-transform: unset;">
                            </div>
                            <div class="form-group">
                                <button class="alt fancy-button" type="submit"> <span class="fa fa-lightbulb-o"></span> send</button>
                            </div>
                        </form>
                    </div>
                </div>
