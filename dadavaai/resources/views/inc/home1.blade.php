                        ...
                        <div class="col-lg-3" style=" margin-left: 20px;">
                            ...
                            <div class="" style="border: solid 1px ; padding: 5px;">
                                <div class="form-inline ">
                                    ...
                                    <label class="radio-inline">
                                        <input type="radio" name="ondemand_type" value="service">Service
                                    </label>
                                ...
                                <div class="col-lg-12" style="padding-left: unset;">
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="service name"  name="ondemand_service" required>
                                            </div>
                                        </div>
                                        <div class="col-lg-2">
                                            <div class="form-group">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                <label class="control-label col-lg-4" for="hour">Hour</label>
                                                <div class="col-lg-8">
                                                    <input type="time" class="form-control" placeholder="hour"  name="hour">
                                                </div>                                            
                                            </div>
                                        </div>
                                </div>
