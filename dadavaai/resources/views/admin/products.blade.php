                    ...
                    <tr id="product{{$product->id}}">
                        ...
                        <td>
                            <div class="table-data-feature">
                                ...
                                data-discount="{{$product->discount}}" data-occasion="{{$product->occasion}}" data-promotion="{{$product->promotion}}" data-clearance="{{$product->clearance}}" data-buy_get="{{$product->buy_get}}" data-combo="{{$product->combo}}" >
                                    <i class="fa fa-eye"></i>
                                </a>
                                @can('edit product')
                            ...
                            <div class="col-sm-10">
                                <div class="form-group">
                                    <div class="checkbox">
                                        ...
                                        <label>
                                            <input type="checkbox" name="combo" id="ecombo" value="1">
                                            Combo
                                        </label>
                                    </div>
                            ...
                            <div class="col-sm-10">
                                <div class="form-group">
                                    <div class="checkbox">
                                        ...
                                        <label>
                                            <input type="checkbox" name="combo" id="scombo" value="1">
                                            Combo
                                        </label>
                                    </div>
