            ...
            <div class="box box-primary">
                ...
                <form action="{{url('/sendMail')}}" id="sendMail" onsubmit="sendMail(event)">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            {{-- <textarea class="form-control" style="height: 300px" disabled>{{$query->message}} </textarea> --}}
                            <div style="border: black 1px solid; padding:20px;">
                                <strong>Query:</strong>
                                <hr>
                                <p>{{$query->message}}</p>
                                <small>---------</small><br>
                                <small>{{$query->name}}</small><br>
                                <small>{{$query->phone}}</small>
                            </div>
                            <textarea id="editor1" name="mailbody" placeholder="Reply:" class="form-control" style="height: 300px"></textarea>
